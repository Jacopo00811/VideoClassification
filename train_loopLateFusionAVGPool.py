...
model = LateFusion(hyperparameters=hyperparameters, load_pretrained=True, fusion_type='avg_pool')
...
for epoch in range(epochs):
    ...
    if test_accuracy > best_test_accuracy:
        ...
        }, f"saved_models/{model.__class__.__name__}AVGPool_best.pth")
